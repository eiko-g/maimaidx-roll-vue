    ...
    <div class="category-list">
      <label class="cat-label all" for="cat-all"
        ><input
          ...
          class="category"
          checked
          @click="changeCurrentCategory('all')"
        />
      ...
      <label class="cat-label pops_anime" for="cat-pops_anime"
        ><input
          ...
          value="pops_anime"
          class="category"
          @click="changeCurrentCategory('pops_anime')"
        />
      ...
      <label class="cat-label niconico" for="cat-niconico"
        ><input
          ...
          value="niconico"
          class="category"
          @click="changeCurrentCategory('niconico')"
        />
      ...
      <label class="cat-label toho" for="cat-toho"
        ><input
          ...
          value="toho"
          class="category"
          @click="changeCurrentCategory('toho')"
        />
      ...
      <label class="cat-label variety" for="cat-variety"
        ><input
          ...
          value="variety"
          class="category"
          @click="changeCurrentCategory('variety')"
        />
      ...
      <label class="cat-label maimai" for="cat-maimai"
        ><input
          ...
          value="maimai"
          class="category"
          @click="changeCurrentCategory('maimai')"
        />
      ...
      <label class="cat-label gekichu" for="cat-gekichu"
        ><input
          ...
          value="gekichu"
          class="category"
          @click="changeCurrentCategory('gekichu')"
        />
