  ...
  <div class="setting-block level">
    ...
    <div class="level-select">
      <label
        ...
        :class="['level-select-label', { active: !settingStore.lvMultiple }]"
      >
        <input
          :checked="!settingStore.lvMultiple"
          @click="settingStore.lvMultiple = false"
      ...
      >
        <input
          :checked="settingStore.lvMultiple"
          @click="settingStore.lvMultiple = true"
